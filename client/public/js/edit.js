...
kara.editWriter = function(track){ //작가 수정
...
kara.keyTrueofFalse = function(key){
	switch (key) {
		case "major C":
		case "major G":
		case "major D":
...
kara.editClef = function(track){ //박자 수정
...
var notepush = { // 선택한 음을 배열에 담는다
	...
	setNote: function(meter){
		this.meter = meter;
		var bNum = this.bNum.split('_'); //마디 번호
